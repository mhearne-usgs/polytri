   ...
   while ( n > 3 ) {     
      ...
      do {
         if (v2->ear) {
            ...
            /* (v1,v3) is a diagonal */
            //PrintDiagonal( v1, v3 );
            xtri1[itrivertex] = v1->v[X];
            ytri1[itrivertex] = v1->v[Y];
            xtri2[itrivertex] = v2->v[X];
            ytri2[itrivertex] = v2->v[Y];
            xtri3[itrivertex] = v3->v[X];
            ytri3[itrivertex] = v3->v[Y];
            itrivertex++;
      ...
      //Missing final triangle...see if we get it here...
      /*xtri1[itrivertex] = v1->v[X];
      ytri1[itrivertex] = v1->v[Y];
      xtri2[itrivertex] = v2->v[X];
      ytri2[itrivertex] = v2->v[Y];
